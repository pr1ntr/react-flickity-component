  ...
  _createClass(FlickityComponent, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var _this$state = this.state,
          flickityReady = _this$state.flickityReady,
      ...
      if (reloadOnUpdate || !prevState.flickityReady && flickityReady) {
        ...
        this.flkty.options.draggable = draggable === undefined ? children ? cellCount > 1 : false : draggable;
        this.flkty.activate();
      } else {
    ...
    key: "renderPortal",
    value: function renderPortal(children) {
      var _this3 = this;
      ...
      if (mountNode) {
        var element = (0, _reactDom.createPortal)(children, mountNode);
        setTimeout(function () {
    ...
    value: function render() {
      ...
      var usableChildren = cellCount === 1 ? this.props.children.props.children : this.props.children;
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (cellCount === 1 && props.children.props.children) {
        cellCount = _react["default"].Children.count(props.children.props.children);
      }
